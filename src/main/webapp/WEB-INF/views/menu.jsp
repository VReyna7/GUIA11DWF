        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/SpringMVC-1.0-SNAPSHOT/libros/create">Registrar libro</a></li>
                        <li><a href="/SpringMVC-1.0-SNAPSHOT/libros/list">Ver lista de libros</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" 
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/SpringMVC-1.0-SNAPSHOT/editoriales/create">Registrar editorial</a></li>
                        <li><a href="/SpringMVC-1.0-SNAPSHOT/editoriales/list">Ver lista de editoriales</a></li>
                    </ul>
                </li>
            </ul>
